...
rendered. In this increment the accessible set SHALL be all persisted
organisations, consistent with the authorization model where any authenticated
user may read the whole compliance domain.
