...
internal class AuthWebFactory : WebApplicationFactory<Program>
{
    ...
    /// <summary>The in-memory evidence ingest store the app serves. Assert its <c>Appended</c> runs.</summary>
    public FakeEvidenceIngestStore EvidenceStore { get; init; } = new();
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureTestServices(services =>
        {
            ...
            services.RemoveAll<IEvidenceIngestStore>();
            services.AddSingleton<IEvidenceIngestStore>(EvidenceStore);
