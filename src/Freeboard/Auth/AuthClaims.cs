...
/// carries the user id, session id, role, and the session auth-state so downstream policies
/// (sudo-mode, the limited-session allowlist, admin checks) read them without another lookup.
/// </summary>
