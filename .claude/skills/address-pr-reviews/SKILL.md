...
description: >-
  Address PR review comments - fix in-scope issues in code, reply to threads,
  and resolve them. Use when asked to address, process, handle, or respond to
  PR review feedback, or to check what reviewers said on a pull request.
...
Same rules as section 2 - if the request is out of scope, reply noting why and
leave the thread unresolved for human review. Do not edit code or resolve the
thread.
