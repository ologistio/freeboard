#!/usr/bin/env bash
#
# plan-implement-review-loop eval checks
#
# Validates the structural integrity of a plan-implement-review-loop session file.
...
SESSION="$GIT_ROOT/tmp/plan-implement-review-loop-session.md"
MID_SESSION=false
for arg in "$@"; do
...
echo "=== Plan-Implement-Review Loop Eval Checks ==="
...
archive_path="${session_dir}/plan-implement-review-loop-history/session-${sid}.md"
